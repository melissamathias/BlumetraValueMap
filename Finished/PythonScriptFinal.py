...
path = '/Users/krishiv/Test/Finished/relationship_chart_spreadsheet_final.xlsx'
...
workbook = openpyxl.load_workbook('/Users/krishiv/Test/Finished/relationship_chart_spreadsheet_final.xlsx')
...
#Features Nodes:
sheet_name1 = 'Features Nodes'
sheet = workbook[sheet_name1]
column2_data_2 = []
for row in sheet.iter_rows(min_row=2, min_col=2, max_col=2, values_only=True):
    column2_data_2.append(row[0])

boxdata3 = "var FeaturesNodesData = "
links_data2 = [{'link': link} for link in column2_data_2]
boxdata4 = "; "


json_string1 = json.dumps(links_data2)
...
for sheet_name in file_handle.sheetnames:
    ...
    for col in range(1, column_print):
        ...
        if sheet_obj == file_handle["Use Cases Nodes"]:
            continue
        if sheet_obj == file_handle['Features Nodes']:
            continue
...
output_path = '/Users/krishiv/Test/Finished/d3_relationship_chartFinalVersion.js'
...
with open(output_path, 'w') as output_file:
    ...
    output_file.write(boxdata2)
    output_file.write(boxdata3)
    output_file.write(json_string1)
    output_file.write(boxdata4)
